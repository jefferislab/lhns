...
df[c(malt.upns,bilateral.VL1.upns,bilateral.VP3.upns),]$class = "uPN"
...
df[mlalt.mpns,]$class = "mPN"
df[mlalt.upns,]$class = "uPN"
...
df[lalt.pns,]$class = "mPN"
df[c(lalt.uni,lalt.mpns5),]$class = "uPN"
...
df[mbonap,"anatomy.group"] = "MBON-a'"
