...
x = c("391716661", "5813096129", "424776680", "425121959", "424780893",
      ...
      "673426956", "544107335", "543321179", "574040939", "638136814",
      "451382570", "517842578", "5813067728", "421957539", "455828904",
      "513404289", "5901195496", "452336897", "551298257", "425471220",
      "512765816", "544107243", "730562988", "5813095395", "456187010", "551989415", "543412198")
y = c("792326206", "327838570")
z = c("420956213", "392307898", "453350926", "390953189", "5901193642", "5813055865",
      "485745927", "546472393", "577835762", "546127037", "577844302",
      "453026933", "545786473", "639240544", "359210228")
w = c("420615275", "421983723", "359905678", "452651486", "359901157",
      "734693858", "545440837", "576812462", "485430376", "760604568",
      "514073078", "667132722", "454045389", "483716037", "575806223",
      "454706490", "697132415",
      "981547981", "328542009", "452323015", "5901193715",
      "360932188", "452651021")
u = "697476780"
ad1 = c(x,y,z,w,u)
...
# ADL03 = ADL03[names(ADL03)%in%hemibrain.lhn.bodyids]
# ADL15 = neuprint_read_neurons("ADL15")
# ADL15 = ADL15[names(ADL15)%in%hemibrain.lhn.bodyids]
# ADL02 = neuprint_read_neurons("ADL02")
# ADL02 = ADL02[names(ADL02)%in%hemibrain.lhn.bodyids]
...
### Wrong CBF
# wrong1 = c("705139000","544107243", "730562988")
...
df[u,"ItoLee_Hemilineage"] = "primary"
df[u,"Hartenstein_Hemilineage"] = "primary"
...
# b1 = c("5813095395", "456187010", "551989415", "543412198") # light = c("120726c3", "130726c1", "130731c1", "130910c0","140514c1")
# df[b1,"cell.type"] = "AD1b1"
# b3 = c("5813021223", "392645419", "5813012028") # light = c("120813c1", "120911c0")
# df[b3,"cell.type"] = "AD1b3"
# b5 = c("581652283", "583015749") # light = c("130731c1", "130729c0", "130801c1", "130802c0", "JJ37")
# df[b5,"cell.type"] = "AD1b5"

b1 = c("5813095395", "456187010", "551989415", "543412198")
df[b1,"cell.type"] = "AD1b1"
...
b3 = c("451382570", "5813047019","455828904") # light = "L1539#4"
df[b3,"cell.type"] = "AD1b3"

b4 = c("575384259","638136814")
df[b4,"cell.type"] = "AD1b4"

b5 = c("5813067728", "5901195496", "421957539", "517842578", "513404289") # light = c("120813c1")
df[b5,"cell.type"] = "AD1b5"

b6 = c("451995734", "611352588", "452336897", "425471220", "512765816") #light = c("120816c1") # "JJ26" # Change to AD1b1
...
g1 = "792326206" # light =  "VGlut-F-200392"
...
# j1 = c("391971977", "5901195761", "298547259", "328883690", "422388958") # dead
...
f1 = c("453350926", "392307898", "420956213") # light = c("Cha-F-100223", "VGlut-F-200319","Cha-F-300272","VGlut-F-400267","VGlut-F-600424","VGlut-F-700522", "130524c0","JJ42")
df[f1,"cell.type"] = "AD1f1"

f2 = c("5813055865") # light = c("Cha-F-100223") # Aspis in the EM
df[f2,"cell.type"] = "AD1f2"

f3 = c("453026933", "545786473", "639240544", "390953189", "5901193642") # light = c("VGlut-F-500156")
df[f3,"cell.type"] = "AD1f3"

f4 = c("546472393", "577835762", "546127037", "577844302") # light = c("Gad1-F-200033","Cha-F-700185")
df[f4,"cell.type"] = "AD1f4"

f5 = "485745927"
df[f5,"cell.type"] = "AD1f5"
...
i2 = c("981547981", "328542009", "452323015", "5901193715") # maybe
df[i2,"cell.type"] = "AD1i2"

i1 = c("359901157", "452651486", "359905678") # light = c("JJ50") # maybe
...
# e1 = c("485430434", "855414220", "887148641", "641278400", "949534412", "610916994") #light = c("Gad1-F-300229","Cha-F-200360","fru-F-300009","Gad1-F-200365","L1614#1","L1827#3")
# df[e1,"cell.type"] = "aSP-g1"
#
# e2 = c("5813115796", "421992069", "485775679", "485430336", "329919036") # light = c("Gad1-F-700032", "fru-F-200156")
# df[e2,"cell.type"] = "aSP-g2"
...
a3 = c("454706490", "697132415") # light = c("120925c1", "121127c1", "121122c1", "121128c3", "L1740#2")
df[a3,"cell.type"] = "AD1a3"

a4 = c("360932188", "452651021", "420615275", "421983723")
...
# df[i5,"cell.type"] = "AD1i5"

# i4 = c("451960272")
# df[i4,"cell.type"] = "AD1i4"
