...
# Groups
x = c("705381843", "766781641", "764006565", "921969630",
      "1011616276", "1130605683", "1259528984", "357490931", "357823645",
      "388513464", "511966686", "512645188", "512981720", "515390688",
      ...
      "700878180", "700878295", "703305408",  "731244892",
      ...
      "887433630", "918123297",  "948812702", "975432645",
      "979519562", "980198319", "883031393", "730882970", "794337453",
       "5813058137", "5813087621", "761580655","760541793",
      "822289778", "1039867920", "732280395", "728483069", "5813098080",
      "823668338", "637121971", "792610827", "882685590",
      "1042572999", "605791875", "606444098",  "762957069",
      "917086906", "826762561",   "579169802", "579169910", "360236724")
...
z  = c("730537677", "764339342", "634712475", "5813010799", "731270909",
       ...
       "635091875", "918468865",  "669857319", "5901197773",
       "762262916", "818888010")
w = c("1011616276", "515390688", "5813010845", "5813014585", "5813035183",
      "5813133775", "605417133", "607104768", "607787481", "638476365",
      "667474054", "669869547", "698180393", "699894933", "700210227",
      "700550360", "703305408", "731244892", "731567967", "731918732",
      "731919293", "759586113", "762948368", "789580340", "793298641",
      "820581199", "823988254", "851684210", "856407289", "856408517",
      "887433630", "918123297", "979519562", "980198319", "1042572999",
      "606444098", "826762561", "579169802", "579169910", "360236724","762263004"
)
av4 = c(x,y,z,w)
...
df[w,"ItoLee_Hemilineage"] = "VLPl4_dorsal"
df[w,"Hartenstein_Hemilineage"] = "BLD3_dorsal"
...
c1 =  c("1011616276", "703305408", "856408517","826762561","979519562")
...
c2 =  c("705381843", "766781641", "764006565", "921969630") # dead # light = c("fru-F-500553", "Gad1-F-100153", "fru-F-400494")
...
a2 = c("637121971") # light = c("Cha-F-000524", "728483249", "Cha-F-200385", "Cha-F-600191", "JJ128")
df[a2,"cell.type"] = "AV4a2"

a4 = c("918123297", "669869547", "856407289",  "5813014585", "980198319","887433630", "731918732", "700550360",  "731567967", "851684210")
...
a3 = c("975432645", "851317951", "820581199", "794337453", "881991445",
       "883031393", "823999989", "917086906", "5901195038") # light = c("L240#5", "L240#16")
df[a3,"cell.type"] = "AV4a3"

a7 =  c("667474054", "823988254", "761580655", "5813010845") #light = c("fru-F-500357", "Gad1-F-700104")
df[a7,"cell.type"] = "AV4a7"

a6 =  c("882685590", "792610827", "1039867920") # light = c("L1385#26")
df[a6,"cell.type"] = "AV4a6"

a5 =  c("604031105", "5813061530", "789580340") #light = c("Gad1-F-200163", "fru-M-300432", "VGlut-F-200021","VGlut-F-200382", "Gad1-F-800028", "L1046#8")
...
e1 =  c("732280395", "640221192","730882970") # light = c("Cha-F-600124") ") # light = c("Cha-F-500116","L1385#1", "L1385#2", "L1385#4")
df[e1,"cell.type"] = "AV4e1"

e2 =  c("607104768", "731244892", "605417133", "638476365","887433630", "731918732", "700550360", "762263004", "762948368","731567967") # light = c("131011c0", "fru-F-600043","L1385#9","131007c1","131009c0")
df[e2,"cell.type"] = "AV4e2"

e3 = c("699894933", "793298641")
df[e3,"cell.type"] = "AV4e3"

e4 =  c("638136190", "669852092") # light = c("Cha-F-000515", "140618c0", "160201c1", "160211c1", "Gad1-F-100077","L1385#3")
df[e4,"cell.type"] = "AV4e4"

e5 =  c("607787481", "5813035183", "700210227")
df[e5,"cell.type"] = "AV4e5"

e6 =  c("515390688")
df[e6,"cell.type"] = "AV4e6"

e7 =  c("606444098", "731919293", "1042572999",
        "579169802", "579169910") #light = c("Gad1-F-100051","L568#7")
df[e7,"cell.type"] = "AV4e7"

#####
# d #
#####

d1 = c("700878295", "357823645", "669171261", "511966686", "5813012083")
df[d1,"cell.type"] = "AV4d1"

d2 =  c("605791875", "762957069","388513464") # light = c("Cha-F-400293")
df[d2,"cell.type"] = "AV4d2"

d3 = c("357490931", "948812702")
df[d3,"cell.type"] = "AV4d3"

d4 = c("5813010525", "607096048")
df[d4,"cell.type"] = "AV4d4"

d5 =  c("512981720", "700878180", "5812980863", "512645188")
df[d5,"cell.type"] = "AV4d5"

d6 = c("669857319", "5901197773", "818888010", "762262916") # light = c("L787#1")
...
cent1 =  c("576773752","545738451", "608465100")
df[cent1,"cell.type"] = "CENT13_a"

cent2 =  c("5813012889", "700884019") # light = c("Cha-F-200378", "Gad1-F-200127", "L1385#8")
df[cent2,"cell.type"] = "CENT13_b"

cent3 =  "5901208658"
df[cent3,"cell.type"] = "CENT13_c"

cent4 = "764339342"
df[cent4,"cell.type"] = "CENT13_d"
...
b2 = c("480931586", "849918343", "911984113", "635091875")
df[b2,"cell.type"] = "AV4b2"

b3 = c("669857319", "5901197773", "762262916", "818888010")
df[b3,"cell.type"] = "AV4b3"

b4 = c("5813012448", "851309562","575729037")
...
b5 = c("857451691", "918468865")
df[b5,"cell.type"] = "AV4b5"

b6 = c("543333530", "511949534", "5813035150")
...
g2 = c("944055652", "944729312", "916763916", "5901194039",
...
g3 =  c("912663435", "881986401", "821306235") # light = c("131008c0")
df[g3,"cell.type"] = "AV4g3"

g4 = c("5901193783", "947462997","542639377", "761575136",  "5813009261") # light = c("131002c2")
df[g4,"cell.type"] = "AV4g4"

g5 =  c("696772937", "634712940", "730537677") #light = c("L1385#6")
df[g5,"cell.type"] = "AV4g5"

g6 = c("912663435", "881986401", "852678239", "5813035204")
df[g6,"cell.type"] = "AV4g6"

g7 =  c("542293528", "573324939", "635385969",  "5813035168", "975072882" )
df[g7,"cell.type"] = "AV4g7"

g8 = c("698829728","761229983", "668148078", "666451615", "667141710")
df[g8,"cell.type"] = "AV4g8"

g9 =  c("665735597", "697456597", "913013165")
df[g9,"cell.type"] = "AV4g9"

g11 = c("5901203780", "947453617", "916773484")
df[g11,"cell.type"] = "AV4g11"

g12 =  c("727808408", "728483249") #light = c("L240#11")
df[g12,"cell.type"] = "AV4g12"

g13 =  c("668485522", "852976677", "698829728")
df[g13,"cell.type"] = "AV4g13"

g14 =  "5813013443"
df[g14,"cell.type"] = "AV4g14"

g15 = c("761232088", "947103902") # light = c("L240#2", "L240#6")
df[g15,"cell.type"] = "AV4g15"

g16 = c("760902933", "788173517")
df[g16,"cell.type"] = "AV4g16"

g17 = "419548541"
df[g17,"cell.type"] = "AV4g17"

g18 =  "605723658"
df[g18,"cell.type"] = "AV4g18"
