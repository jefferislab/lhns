...
a1 = c("5813013530", "640220321", "580546081", "5813013792") # light = c("L629#2", "Gak1-F-800214")
df[a1,"cell.type"] = "AV2a1" # keep

a2 = c("612285653", "486444499", "674001478", "948135822") #light = c("Gak1-F-000240")
df[a2,"cell.type"] = "AV2a2"

a3 = c("516771668", "577801333")
df[a3,"cell.type"] = "AV2a3"

a4 = c("485732870", "576774002")
df[a4,"cell.type"] = "AV2a4"

a5 = "609168709"
df[a5,"cell.type"] = "AV2a5"

a6 = c("575042709") # light = c("Gad1-F-600244")
df[a6,"cell.type"] = "AV2a6"
