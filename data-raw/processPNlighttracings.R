...
pn.axons.light = as.neuronlistfh(pn.axons.light,dbdir = 'inst/extdata/data/', WriteObjects="missing")
pn.axons.light.dps = as.neuronlistfh(pn.axons.light.dps,dbdir = 'inst/extdata/data/', WriteObjects="missing")
